...
const MainPage = () => {
    ...
    const addProduct = (code: number) => {
        ...
        const foundedProductId = newOrder.content.findIndex((product) => product.id === newProduct.id)
        ...
        if(foundedProductId >= 0) {
            ...
            foundedProduct.sum = (foundedProduct.price - foundedProduct.discount) * foundedProduct.quantity
            
            newActiveItem = foundedProductId
        
        } else {
            newOrder.content.push({...newProduct, quantity: 1, sum: newProduct.price - newProduct.discount})
            newActiveItem = newOrder.content.length - 1
        }
